...
export var data = {
    ...
    description: 'Not only is this first blog post meant to be inviting and informative, you can get a taste of how this Blog post looks 👀'
}
...
export var render = data =>
  ...
  The posts in this sample blog are meant to guide you through how to install this Blog on your machine and spin up your own site with this starter project. You don’t need web development experience to follow along. All you need is a willingness to learn! You can work at your own pace and skip around if you like.
  
  > <p><strong>😰 Stuck?</strong></p>
  > <p>Try <a href="${data.pkg.bugs.url}">submitting an issue on GitHab</a> where friendly folks can try to help.</p>
